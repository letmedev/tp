        ...
        if($this->isConnected()){
            ...
            if(isset($_POST['btnConnexion']) && $_POST['btnConnexion'] == 'Connexion'){
                ...
                if($result){
                    ...
                    $this->msg .= "<div class='msgSuccess'>Bienvenue " . $_SESSION['user']['pseudo'] . " !<br /> Pour commencer votre navigation cliquez <a href=\"". superController::url ."produit/index\">ici</a></div>";
                } else{
