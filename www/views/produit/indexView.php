...
<div class="blocGris">
    ...
    <div class="zoneAnnonce">
        <div class="blocAnnonce">
            ...
            <div class="btnAnnonce"><?php
                if($this->isConnected()){
                    if(isset($produitTop[0]['id_produit']) && !empty($produitTop[0]['id_produit'])){
                        echo '<a href="' . \controller\superController\superController::URL . 'produit/fiche/'.$produitTop[0]['id_produit'] . '">Voir cette salle</a>';
                    }
                } else{
                    echo '<a href="' . \controller\superController\superController::URL . 'membre/connexion/'.$produitTop[0]['id_produit'] . '"><span class="connectYou">Connectez-vous pour voir cette salle</span></a>';
                }
                ?>
            </div>
        </div>
        <div class="blocAnnonce marginLeft50">
            ...
            <div class="btnAnnonce"><?php
                if($this->isConnected()){
                    if(isset($produitTop[1]['id_produit']) && !empty($produitTop[1]['id_produit'])){
                        echo '<a href="' . \controller\superController\superController::URL . 'produit/fiche/'.$produitTop[1]['id_produit'] . '">Voir cette salle</a>';
                    }
                } else{
                    echo '<a href="' . \controller\superController\superController::URL . 'membre/connexion/'.$produitTop[1]['id_produit'] . '"><span class="connectYou">Connectez-vous pour voir cette salle</span></a>';
                }
                ?>
            </div>
        </div>
        <div class="blocAnnonce marginLeft50">
            ...
            <div class="btnAnnonce"><?php
                if($this->isConnected()){
                    if(isset($produitTop[2]['id_produit']) && !empty($produitTop[2]['id_produit'])){
                        echo '<a href="' . \controller\superController\superController::URL . 'produit/fiche/'.$produitTop[2]['id_produit'] . '">Voir cette salle</a>';
                    }
                } else{
                    echo '<a href="' . \controller\superController\superController::URL . 'membre/connexion/'.$produitTop[2]['id_produit'] . '"><span class="connectYou">Connectez-vous pour voir cette salle</span></a>';
                }
                ?>
            </div>
        </div>
        <div class="blocAnnonce marginLeft50">
            ...
            <div class="btnAnnonce"><?php
                if($this->isConnected()){
                    if(isset($produitTop[3]['id_produit']) && !empty($produitTop[3]['id_produit'])){
                        echo '<a href="' . \controller\superController\superController::URL . 'produit/fiche/'.$produitTop[3]['id_produit'] . '">Voir cette salle</a>';
                    }
                } else{
                    echo '<a href="' . \controller\superController\superController::URL . 'membre/connexion/'.$produitTop[3]['id_produit'] . '"><span class="connectYou">Connectez-vous pour voir cette salle</span></a>';
                }
                ?>
            </div>
        </div>
...
<div class="blocGris">
    ...
    <div class="zoneAnnonce">
        <div class="blocAnnonce">
            ...
            <div class="btnAnnonce"><?php
                if($this->isConnected()){
                    if(isset($produitMinute[0]['id_produit']) && !empty($produitMinute[0]['id_produit'])){
                        echo '<a href="' . \controller\superController\superController::URL . 'produit/fiche/'.$produitMinute[0]['id_produit'] . '">Voir cette salle</a>';
                    }
                } else{
                    echo '<a href="' . \controller\superController\superController::URL . 'membre/connexion/'.$produitMinute[0]['id_produit'] . '"><span class="connectYou">Connectez-vous pour voir cette salle</span></a>';
                }
                ?>
            </div>
        </div>
        <div class="blocAnnonce marginLeft50">
            ...
            <div class="btnAnnonce"><?php
                if($this->isConnected()){
                    if(isset($produitMinute[1]['id_produit']) && !empty($produitMinute[1]['id_produit'])){
                        echo '<a href="' . \controller\superController\superController::URL . 'produit/fiche/'.$produitMinute[1]['id_produit'] . '">Voir cette salle</a>';
                    }
                } else{
                    echo '<a href="' . \controller\superController\superController::URL . 'membre/connexion/'.$produitMinute[1]['id_produit'] . '"><span class="connectYou">Connectez-vous pour voir cette salle</span></a>';
                }
                ?>
            </div>
        </div>
        <div class="blocAnnonce marginLeft50">
            ...
            <div class="btnAnnonce"><?php
                if($this->isConnected()){
                    if(isset($produitMinute[2]['id_produit']) && !empty($produitMinute[2]['id_produit'])){
                        echo '<a href="' . \controller\superController\superController::URL . 'produit/fiche/'.$produitMinute[2]['id_produit'] . '">Voir cette salle</a>';
                    }
                } else{
                    echo '<a href="' . \controller\superController\superController::URL . 'membre/connexion/'.$produitMinute[2]['id_produit'] . '"><span class="connectYou">Connectez-vous pour voir cette salle</span></a>';
                }
                ?>
            </div>
        </div>
        <div class="blocAnnonce marginLeft50">
            ...
            <div class="btnAnnonce"><?php
                if($this->isConnected()){
                    if(isset($produitMinute[3]['id_produit']) && !empty($produitMinute[3]['id_produit'])){
                        echo '<a href="' . \controller\superController\superController::URL . 'produit/fiche/'.$produitMinute[3]['id_produit'] . '">Voir cette salle</a>';
                    }
                } else{
                    echo '<a href="' . \controller\superController\superController::URL . 'membre/connexion/'.$produitMinute[3]['id_produit'] . '"><span class="connectYou">Connectez-vous pour voir cette salle</span></a>';
                }
                ?>
            </div>
        </div>
